...
dataBefore = 'D:/4-UNIVERSITY/Thesis/5- Other/Datasets/YooChoose Dataset/yoochoose-data/yoochoose-clicks.dat' #Path to Original Training Dataset "Clicks" File
dataTestBefore = 'D:/4-UNIVERSITY/Thesis/5- Other/Datasets/YooChoose Dataset/yoochoose-data/yoochoose-test.dat' #Path to Original Testing Dataset "Clicks" File
dataAfter = 'D:/4-UNIVERSITY/Thesis/5- Other/Datasets/YooChoose Dataset/RecSys_Dataset_After/' #Path to Processed Dataset Folder
...
# print('Number of short sessions that we detected and removed : ', str(shortSessionCounter))
# D:\4-UNIVERSITY\Thesis\5- Other\Datasets\YooChoose Dataset\RecSys_Dataset_After